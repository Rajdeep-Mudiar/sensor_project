# sys module helps to connect with the python interpreter
import sys
...
class DataIngestion:
    ...
    def export_data_into_feature_store_file_path(self)->pd.DataFrame:
        try:
            ...
            logging.info(f"Saving Exported data to into feature store file path : {raw_file_path}")

            # Create feature store file path
