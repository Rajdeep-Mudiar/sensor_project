...
class DataTransformationConfig:
   artifact_dir=os.path.join(artifact_folder)
    ...
    # npy --> stores file in numpy format
   transformed_train_path=os.path.join(artifact_dir,"train.npy")
...
class DataTransformation:
   ...
   def get_data(feature_store_file_path: str) ->pd.DataFrame:
      try:
         ...
         # Renames the Good Bad column to TARGET_COLUMN
   ...
   def initiate_data_transformation(self):
      ...
      try:
         ...
         X_train,X_test,y_train_y_test=train_test_split(X,y,test_size=0.2)
